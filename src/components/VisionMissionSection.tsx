...
// Drop the two PNGs into src/assets/images/ alongside hero-mosaic.svg
import visionImg from '../assets/images/vision-transformation.png'; // farmer → greenhouse → smart city
import missionImg from '../assets/images/mission-target.png';       // dartboard / target graphic
...
// Organic blob shape used for the image panels
const BLOB = '63% 37% 54% 46% / 43% 47% 53% 57%';

export const VisionMissionSection: React.FC = () => {
  return (
    <section id="vision-mission" className="relative bg-white py-20 md:py-28 overflow-hidden">
      <div className="space-y-24 md:space-y-32">

        {/* ================= VISION — image blob left (rose bar bleeds to screen edge), text right ================= */}
        <div className="relative">
          {/* rose accent — anchored to the true left edge of the viewport, not the content container */}
          <div
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-[280px_1fr] gap-10 md:gap-16 items-center">
            ...
            >
              ...
              <p className="text-sm md:text-base text-slate-600 leading-relaxed mt-5">
                To be a leading Malaysian strategic transformation and project development
                company driving sustainable economic growth through innovation, investment
                and technology. We partner with government agencies and private investors
                to turn national priorities into projects that break ground and deliver
                measurable impact. Our work spans agriculture modernization, high-value
                industry, and the infrastructure that supports long-term growth.
              </p>
        ...
        {/* ================= MISSION — text left, image blob right (teal bar bleeds to screen edge) ================= */}
        <div className="relative">
          {/* teal accent — anchored to the true right edge of the viewport */}
          <div
              ...
              <ul className="mt-6 space-y-3">
                {MISSION_POINTS.map((point, idx) => (
                  <li key={idx} className="flex items-start gap-2.5">
                    ...
                    <span className="text-base text-slate-600 leading-relaxed">{point}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
