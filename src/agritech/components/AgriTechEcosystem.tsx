...
export const AgriTechEcosystem: React.FC = () => {
  return (
    <section
      ...
      className="py-24 bg-[#0a1620] text-white relative overflow-hidden border-b border-[#0a1620]"
    >
      ...
      <div className="absolute inset-0 z-0 opacity-20">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#0a1620_1px,transparent_1px),linear-gradient(to_bottom,#0a1620_1px,transparent_1px)] bg-[size:48px_48px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-4 space-y-5 text-left">
            ...
            >
              <span className="bg-[#0a1620] border border-[#0a1620] text-stone-300 px-3 py-1.5 rounded-lg">
          ...
          <div className="lg:col-span-8 relative">
            <motion.div
              ...
              className="bg-[#0a1620]/90 border border-stone-800/50 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl relative"
            >
              <div className="grid grid-cols-1 md:grid-cols-7 gap-6 items-center">
                ...
                <div className="md:col-span-3 space-y-4">
                  ...
                  {/* Node 1: Government */}
                  <div className="flex items-center justify-between p-3.5 rounded-xl bg-[#0a1620]/80 border border-stone-700/40 hover:border-stone-500/70 hover:bg-[#0a1620] transition-all group">
                    ...
                    <div className="w-10 h-10 rounded-full bg-[#0a1620] border border-stone-400/60 flex items-center justify-center text-stone-300 shrink-0 shadow-sm group-hover:scale-110 transition-transform">
                ...
                <div className="md:col-span-1 flex flex-col items-center justify-center my-4 md:my-0">
                  <div className="relative flex items-center justify-center">
                    ...
                    {/* Center Core Circle */}
                    <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#0a1620] via-[#0a1620] to-[#8e8e8e] border-2 border-[#c6c6c6] flex flex-col items-center justify-center shadow-[0_0_30px_rgba(198, 198, 198,0.4] z-10">
